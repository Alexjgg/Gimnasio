<div class="container-fluid">
  ...
  <div class="row justify-content-center inicio_heigth pt-5">
    ...
    <div class="col-lg-4 img_contenedor">
      <img class="img_fondo mx-auto" src="assets/img/inicio1.jpg" alt="Imagen del gimnasio"></img>
    </div>
  </div>
    ...
    <div class="col-lg-8 ">
      ...
      <div class="row">
        ...
        <div class="col-lg p-3">
          ...
          <img class="icons" src="assets/img/spinning.png" alt="imagen icono de spinning"></img>
        </div>
        <div class="col-lg p-3">
          <div class="txt_icons">Zumba</div>
          <img class="icons" src="assets/img/zumba.png" alt="imagen icono de zumba"></img>
        </div>
      </div>
      <div class="row">
        <div class="col-lg p-3">
          <div class="txt_icons">Defensa personal</div>
          <img class="icons" src="assets/img/defensapersonal.png" alt="imagen icono de Defensa personal"></img>
        </div>
        <div class="col-lg p-3">
          <div class="txt_icons">Body combat</div>
          <img class="icons" src="assets/img/bodycombat.png" alt="imagen icono de Body combat"></img>
        </div>

        <div class="col-lg p-3">
          <div class="txt_icons">Circuito aire libre</div>
          <img class="icons" src="assets/img/circuitoairelibre.png" alt="imagen icono de Circuito de aire libre"></img>
        </div>
      </div>
    </div>
  </div>
